					...
					<div class="col-12 layout-spacing">
						<div class="row">
							<div class="col-md-3 col-sm-6 col-12">
								<select v-model="selectedCategory" v-on:change="loadCourses" class="placeholder js-states form-control">
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-content">
                                ...
                                <div class="row">
                                    ...
                                    <div v-for="item in course.courses" class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 layout-spacing">
                                        <div class="card component-card_2">
                                            <div class="card-body">
                                                <h5 class="card-title">{{item.course_name}} - {{item.category_name}}</h5>
			...
			methods: {
				...
				subscribeCourse: (event) => {
					...
					Notiflix.Confirm.Show(
							'Really?',
							'Do you want to subscribe this class?',
							'Yes',
							'No',
